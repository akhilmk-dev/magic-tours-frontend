            ...
            <div className="relative z-10 px-6 sm:px-8 md:px-12 lg:px-16 pt-16 sm:pt-20 md:pt-24 lg:pt-28 pb-2 sm:pb-4">
                <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 xl:gap-24">
                    ...
                    <div className="flex-1">
                        ...
                        {/* CTA Button */}
                        <Link href="/private-jets" className="inline-flex items-center gap-3 bg-[#FDB338] hover:bg-[#e9a42f] text-brand-magic font-heading font-bold px-8 py-4 rounded-full text-sm transition-all shadow-lg shadow-[#FDB338]/20 group">
                            Explore More
