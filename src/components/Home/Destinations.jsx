                ...
                <div className="flex flex-col xl:flex-row gap-10 xl:gap-12 items-center">
                    ...
                    <div className="xl:w-[420px] xl:shrink-0 text-left pr-4 xl:pr-0">
                        ...
                        <Link href={buttonLink}>
                            <button className="flex items-center gap-4 bg-brand-magic text-white px-8 py-4 rounded-[2rem] font-heading font-bold text-base hover:opacity-90 transition-all group max-w-[220px] leading-tight text-left">
