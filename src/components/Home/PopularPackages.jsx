        ...
        <section className="py-16 bg-white relative overflow-hidden font-sans">
            ...
            <div className="absolute inset-0 opacity-[0.03] pointer-events-none z-0">
                <svg width="100%" height="100%" viewBox="0 0 1440 800" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M50 150 Q 300 50, 600 200 T 1200 150" stroke="#0F1E32" strokeWidth="2" strokeDasharray="12 12" />
                    <path d="M100 650 Q 400 550, 750 700 T 1350 650" stroke="#0F1E32" strokeWidth="2" strokeDasharray="12 12" />
                </svg>
            </div>
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="text-center mb-12">
                    <div className="inline-flex items-center gap-2 bg-[#F2F6FF] px-5 py-2 rounded-full mb-4">
                        <Plane className="text-[#0F1E32] rotate-45" size={12} />
                            ...
                            return (
                                <motion.div
                                    ...
                                    animate={{
                                        ...
                                        backgroundColor: isFocused ? "#FFFFFF" : "#0F1E32"
                                    }}
                                    transition={{
                                        duration: 0.3,
                                        ease: "easeOut"
                                ...
                                >
                                    ...
                                    <div className="relative h-[40%] w-full">
                                        ...
                                        {/* Duration Banner */}
                                        <div className="absolute top-4 left-0 bg-[#0F1E32] text-white py-2 px-4 rounded-r-2xl flex items-center gap-2">
                                    ...
                                    <div className={`flex-1 p-6 flex flex-col relative z-10
                                        ${isFocused ? 'bg-white rounded-t-[2.5rem] -mt-10 pt-8' : 'bg-[#0F1E32]'}
                                    `}>
                                        <h3 className={`text-[24px] font-bold mb-3 ${isFocused ? 'text-[#0F1E32]' : 'text-white'}`}>{pkg.title}</h3>
                                        ...
                                        {isFocused ? (
                                            <div className="bg-[#FAF8F5] p-4 rounded-[1.5rem] space-y-3 mb-6">
                                                <div className="flex items-center gap-3 text-[#0F1E32] font-semibold text-[13px]">
                                        ...
                                        <div className="mt-auto flex items-end justify-between transition-colors">
                                            <div className="flex flex-col">
                                                {isFocused && (
                                                    <div className="mb-2">
                                                        <span className="text-[#FFA500] text-[20px] font-black leading-none">AED {pkg.price}</span>
                                                        <span className="block text-[8px] font-bold uppercase text-gray-400">Per Day</span>
                                                    </div>
                                                )}
                                                <button className={`text-[12px] font-bold transition-colors text-left ${isFocused ? 'text-[#0F1E32] underline' : 'text-[#8E99AF]'}`}>
                                                    See More
                                                </button>
                                            </div>
                                            ...
                                            <div className="flex flex-col items-end">
                                                {!isFocused ? (
                                                    <>
                                                        <span className="text-[#FFA500] text-[24px] font-black leading-none">AED {pkg.price}</span>
                                                        <span className="text-[10px] font-bold uppercase tracking-wider text-[#8E99AF]">Per Day</span>
                                                    </>
                                                ) : (
                                                    <button className="bg-[#0F1E32] text-white px-7 py-3 rounded-full font-bold text-[12px]">
                                                        Book Now
                                                    </button>
                                                )}
                                            </div>
