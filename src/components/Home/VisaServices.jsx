        ...
        <section className="relative bg-white py-8 sm:py-10 md:py-12 px-6 sm:px-8 md:px-12 lg:px-16">
            <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-10 xl:gap-16">
                ...
                <div className="flex-1">
                    ...
                    {/* CTA Button */}
                    <Link href={buttonLink} className="inline-flex items-center gap-2 bg-[#FDB338] hover:bg-[#e9a42f] text-brand-heading font-heading font-bold px-6 py-3 rounded-full text-xs sm:text-sm transition-all shadow-lg shadow-[#FDB338]/20 group">
                        {buttonText}
